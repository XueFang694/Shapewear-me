"""Connecteur SKIMS v1.1 — avec fallback HTML pour la disponibilité."""
...
class SkimsConnector(ShopifyConnectorMixin, BaseConnector):
    def __init__(self, config_path: Path | None = None):
        super().__init__(config_path=config_path or _CONFIG_PATH)

    def get_metadata(self) -> ConnectorMeta:
        return ConnectorMeta(name="SKIMS", slug="skims", version="1.1",
