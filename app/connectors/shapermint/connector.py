"""Connecteur Shapermint — moteur shopify_json."""
...
class ShapermintConnector(BaseConnector):
    ...
    def get_metadata(self) -> ConnectorMeta:
        return ConnectorMeta(name="Shapermint", slug="shapermint", version="1.0",
    ...
    def get_product_urls(self, category: Category) -> list[str]:
        ...
        for url in paginator.iter_pages(base):
            try:
                ...
                log.error("Erreur pagination Shapermint", url=url, error=str(exc)); break
